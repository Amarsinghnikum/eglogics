    ...
    <div class="container-fluid">
        <div class="row clearfix">
            ...
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    <ul class="nav nav-tabs">
                        <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#about">Update Department</a></li>                      
                    </ul>
                    <div class="tab-content">
                        ...
                        @method('PATCH')
                            ...
                            <div class="col-lg-6 col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="dept_name" id="dept_name" value="{{ $department->dept_name }}">
                                </div>
                            </div>
                           </div>
                            <div class="row clearfix">
                              <div class="col-md-12">
                                <button type="submit" id="update_data" value="{{ $department->id }}" class="btn btn-info btn-round">Save</button>
                              <hr>
                                </div>
                            </div>
                          </div>     
...
<script src="https://unpkg.com/sweetalert/dist/sweetalert.min.js"></script>
    ...
    $(document).on("click", "#update_data", function() { 
        var url = "{{URL('update-department/'.$department->id)}}";
        var id= 
		$.ajax({
			url: url,
			type: "PATCH",
