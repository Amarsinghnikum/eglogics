    ...
    <div class="container-fluid">
        <div class="row clearfix">
            ...
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    <ul class="nav nav-tabs">
                        <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#about">Update Incharge</a></li>                      
                    </ul>
                    <div class="tab-content">
                        
                        <div class="tab-pane body active" id="about">
                    <form action="{{url('/update-incharge/'.$incharge->id)}}" method="post">
                        @csrf
                        @method('PUT')
                            <div class="row">
                            <div class="col-lg-6 col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="incharge_name" value="{{ $incharge->incharge_name }}">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6 col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="email" value="{{ $incharge->email }}">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6 col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="password" value="{{ $incharge->password }}">
                                </div>
                            </div>
                            ...
                            <div class="row clearfix">
                              <div class="col-md-12">
                                <button type="submit" name="submit" class="btn btn-info btn-round">Save</button>
                              <hr>
                                </div>
                            </div>
                          </div>     
