    ...
    <div class="container-fluid">
        <div class="row clearfix">
            ...
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    <ul class="nav nav-tabs">
                        <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#about">Department List</a></li>
                        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#Account">Add Department</a></li>                        
                    </ul>
                    <div class="tab-content">
                            ...
                            <div class="body">
                                ...
                                <table class="table table-hover m-b-0" id="myTable">
                                        ...
                                        <tbody>
                                            <td>{{$i}}</td>
                                            <td>{{$val->dept_name}}</td>
                                            <td><button class="btn btn-primary"><a href="{{ url('edit-department/'.$val->id) }}">Edit</a></button></td>
                                            <td><button class="btn btn-danger delete" value="{{$val->id}}">Delete</button></td>
                                        </tbody>
                                        @php $i=$i+1; @endphp
                                        @endforeach
                                    </table>
                    ...
                    <form method="POST">
                        @csrf
                            ...
                            <div class="row clearfix">
                              <div class="col-md-12">
                                <button type="submit" class="btn btn-success frm-submit">Save</button>
                              <hr>
                                </div>
                            </div>
                          </div>     
