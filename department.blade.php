                ...
                <div class="card">
                            ...
                            <div class="body">
                                ...
                                <table class="table table-hover m-b-0" id="myTable">
                                        ...
                                        <tbody>
                                            ...
                                            <td><button class="btn btn-danger"><a href="{{ url('/delete-department/'.$val->id) }}">Delete</a></button></td>
                                        </tbody>
                                        @php $i=$i+1; @endphp
                                        @endforeach
                                    </table>
                    ...
                    <form id="frm">
                        @csrf
                            ...
                            <div class="row clearfix">
                              <div class="col-md-12">
                                <button type="submit" name="submit" id="frmSubmit" class="btn btn-info btn-round">Save</button>
                              <hr>
                                </div>
                            </div>
                          </div>     
